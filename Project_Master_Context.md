...
| 관짝춤 물리 B/C | 필요 시 | 기본은 **순수 충돌(A)**. 좌우 조작·수치·어깨 R=27 **Play 검증**(2026-08-07). Phase별 Amp/Speed는 **후속**. 지지점 힘 B/C는 질문→승인 |
...
- [x] 관짝춤(Coffin Dance) 운구인 좌우 조작 개편 완료 (상시 미세 도치, 비선형 이탈 가속, 홀드 가속 도입) (2026-08-07)
...
*마스터 파일 갱신: 2026-08-07 — 관짝춤 좌우 조작 Play 검증·수치 확정 · 어깨 R=27*
